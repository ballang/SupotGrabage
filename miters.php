                            ...
                            <div class="col-md-12">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">จัดการข้อมูลมิเตอร์</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group mb-3">
                                            <select class="custom-select" id="inputGroupSelect02">
                                                ...
                                                <option value="2">โปร่งตะคลอง</option>
                                                <option value="3">มหาชัย</option>
                                            </select>
                                            ...
                                            <table class="table table-bordered"  width="100%" cellspacing="0" id="tb-data">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><div style="width:120px;" align='center'>รหัสมิเตอร์</div></th>  
                                                        <th width='100%'><div style="width:100%;">เจ้าของ</div></th>
                                                        <th><div style="width:80px;"align='center'>บ้านเลขที่</div></th>                         
                                                        <th><div style="width:100px;" align='center'>หน่วยมิเตอร์</div></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    for ($i = 0; $i < 10; $i++) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><div style="width:100px;" align='center'>0001</div></td>                                                  
                                                            <td>
