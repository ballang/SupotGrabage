                                        ...
                                        <table class="table table-bordered"  width="100%" cellspacing="0" id="tb-data">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><div style="width:100px;">เลขที่ใบแจ้งหนี้</div></th> 
                                                    ...
                                                    <th><div style="width:80px;">รวมเป็นเงิน</div></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                for ($i = 0; $i < 15; $i++) {
                                                    ?>
                                                    <tr>
                                                        <td><div style="width:100px;">IV64000<?php echo $i + 1 ?></div></td>
                                                        ...
                                                        <td><div style="width:80px;">50</div></td>
                                                        <td><div style="width:80px;">500</div></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
